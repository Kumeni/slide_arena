...
async function sendUSDT() {
    ...
    try {
        ...
        uploadTxHash(txHash);
        // 👉 Immediately capture hash and detach from ethers lifecycle
        ...
        alert("0.05 USDT sent successfully!");*/
...
const uploadTxHash = async (tx_hash) => {
    API.post("./api/crypto-payment.php", {
        tx_hash: tx_hash,
